var features = {
    ...
    "island" : { // Holy magic number batman
        // Island Base
        base  : { detail           : 3,    // Icosahedron detail parameter
                  noise : { spike  : 0.08, // Multiplier on exponential noise
                            top    : 100,  // Size parameter of top turblent noise
                            bottom : 200 },  // Size parameter of bottom turbulent noise
                  peak : { mult    : 12,   // Just give up understanding these
                           reduce  : 1.2,  // Even I don't fully comprehend what's going on here
                           shift   : 4 },    // Looks good though
                  displace         : 3,    // Bottom half displacment ( negative z )
                  perturb          : 0.5,  // All vertex perturb amount
                  material         : { color : 0x566053,
                                       shading : THREE.FlatShading,
                                       shininess : 10,
                                       refractionRatio : 0.1 } },

        // Sand bowls
        sand  : { modifier : 3,    // Raking wave scalar
                  height   : 0.2,  // Wave height modifier
                  maxPatch : 2,    // Maximum number of sandy ovals per island
                  material : { color : 0xfcfbdf,
                               shading : THREE.FlatShading,
                               shininess : 10,
                               refractionRatio : 0.5 } },

        // Grass covering
        grass : { extrusions : [ { dMin   : 0.8,  // This extrudes grass on the flat top of the island,
        ...
        // Snow covering
        snow : { extrusions : [ { dMin   : 0.3, // Create snow caps - Only place snow on
