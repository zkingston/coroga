...
function HexLatticeRockGeometry( width, length, height) {
    ...
    var geometry = new THREE.ClosedCylinderGeometry(
        t_rad, b_rad, height, r_seg, h_seg ).rotateX( Math.PI / 2 );
...
function flatRock(){
    var diameter = continuousUniform(rock_cfg.flat.diameter.min, rock_cfg.flat.diameter.max);
    var height = continuousUniform(rock_cfg.flat.height.min, rock_cfg.flat.height.max);
...
function tallRock(maxRadius){
    var diameter = continuousUniform(rock_cfg.tall.diameter.min, rock_cfg.tall.diameter.max);
    var height = continuousUniform(rock_cfg.tall.height.min, rock_cfg.tall.height.max);
    var geometry = HexLatticeRockGeometry(
        diameter,
        continuousUniform(.8,1) * diameter,
        height
...
function shortRock(maxRadius){
    var diameter = continuousUniform(rock_cfg.short.diameter.min, rock_cfg.short.diameter.max);
    var height = continuousUniform(rock_cfg.short.height.min, rock_cfg.short.height.max);
    var geometry = HexLatticeRockGeometry(
        diameter,
        continuousUniform(.8,1) * diameter,
        height
...
function archedRock(maxRadius){
    var diameter = continuousUniform(rock_cfg.arched.diameter.min, rock_cfg.arched.diameter.max);
    var height = continuousUniform(rock_cfg.arched.height.min, rock_cfg.arched.height.max);
...
function reclineRock(maxRadius){
    var diameter = continuousUniform(rock_cfg.reclining.diameter.min, rock_cfg.reclining.diameter.max);
    var height = continuousUniform(rock_cfg.reclining.height.min, rock_cfg.reclining.height.max);
    var geometry = HexLatticeRockGeometry(
            diameter,
            diameter,
            height
...
function generateCluster_Buddha(x,y){
    var rock = RockGeometryAggregator(
        ...
        [new THREE.Vector3(0,0,0), new THREE.Vector3(-6,0,0), new THREE.Vector3(6,0,0)],
        igneousMaterial());
    rock.addToObjectProject( environment.island, x, y);
    return rock;
}
...
function generateCluster_BigDick(x,y){
    var rock = RockGeometryAggregator(
        ...
        [new THREE.Vector3(0,0,0), new THREE.Vector3(-2,-2,0), new THREE.Vector3(2,-2,0)],
        igneousMaterial());
    rock.addToObjectProject( environment.island, x, y);
    return rock;
}
...
function generateCluster_WoodFireWater(x,y){
    var rock = RockGeometryAggregator(
        ...
        [new THREE.Vector3(4,0,0), new THREE.Vector3(-3,-2,0), new THREE.Vector3(3,-2,0)],
        igneousMaterial());
    rock.addToObjectProject( environment.island, x, y);
    return rock;
}
