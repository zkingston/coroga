...
function BrickBoxGeometry( width, height ) {
    ...
    var brickN1 = BrickLayerGeometry( width + 2 * offset, offset, depth, width / 4 );
    brickN1.translate( 0, height / 2 + offset / 2, 0 );

    var brickS1 = BrickLayerGeometry( width + 2 * offset, offset, depth, width / 4 );
    ...
    var brickN2 = BrickLayerGeometry( width + 6 * offset, offset, depth, width / 4 );
    brickN2.translate( 0, height / 2 + offset / 2 + offset * 2, 0 );

    var brickS2 = BrickLayerGeometry( width + 6 * offset, offset, depth, width / 4 );
    brickS2.translate( 0, -( height / 2 + offset / 2 + offset * 2 ), 0 );

    var brickE2 = BrickLayerGeometry( height + 4 * offset, offset, depth, height / 4 );
    brickE2.rotateZ( Math.PI / 2 );
    brickE2.translate( width / 2 + offset / 2 + offset * 2, 0, 0 );

    var brickW2 = BrickLayerGeometry( height + 4 * offset, offset, depth, height / 4 );
